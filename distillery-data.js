...
const islayData = [
  ...
  { name:"Bruichladdich Distillery", name_en:"Bruichladdich Distillery", name_jp:"ブルックラディ蒸留所", area:"Islay", lat:55.76653564455231, lng:-6.36228205833504, url:"https://www.bruichladdich.com" },
  ...
  { name:"Kilchoman Distillery", name_en:"Kilchoman Distillery", name_jp:"キルホーマン蒸留所", area:"Islay", lat:55.78062430196737, lng:-6.445396633584069, url:"https://www.kilchomandistillery.com" },
  ...
  { name:"Port Ellen Distillery (Revival)", name_en:"Port Ellen Distillery (Revival)", name_jp:"ポートエレン蒸留所（再稼働）", area:"Islay", lat:55.63433756731518, lng:-6.19470109721084, url:"https://www.discoveringportellen.com" },
  { name:"Laggan Bay Distillery (New)", name_en:"Laggan Bay Distillery (New)", name_jp:"ラガンベイ蒸留所（新設）", area:"Islay", lat:55.683669382501165, lng:-6.245920944978663, url:"" }
];
/* ------------------------------------------------------------
...
const japanData = [
  ...
  { name: "新潟麦酒株式会社 忍蒸溜所", name_jp: "新潟麦酒株式会社 忍蒸溜所", name_en: "Niigata Beer Co. Shinobu Distillery", area: "Niigata", lat: 37.8063279115294, lng: 138.849422490482, url: "https://shinobudistillery.com/home/" },
